...
<main>
        ...
        <form action="../controller/paciente/consultar-paciente.php" method="post" class="w-100">
            ...
            <div class="form-row d-flex justify-content-center align-items-center mt-5">
                <div class="form-group col-md-6 d-flex align-items-center justify-content-center color-gray">
                    <!--<input type="hidden" value="<?php //echo PESQUISAR_POR_NOME; 
                                                    ?>" id="hdSearchType" name="hdSearchType" /> -->
                    <div class="container-search w-75"> <input type="text" name="txtPesquisa" id="txtPesquisa" class="input-for-search w-100" placeholder="Digite o nome do paciente" /> </div>
                    <div class="ml-3">
    ...
    <div class="modal fade bd-example-modal-lg" id="modal-filter-paciente" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title font-bold" id="modal-title-filter-paciente"> <i class="fas fa-filter ml-3"></i> Escolha a opção de filtro </h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" id="editar-paciente" data-dismiss="modal">OK</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade bd-example-modal-lg" id="modal-view-paciente" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button id="update-paciente" class="btn btn-danger" data-dismiss="modal">Ok</button>
                    </div>
            </div>
        </div>
    </div>
