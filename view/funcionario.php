...
<main>
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center mt-2">
            ...
            <fieldset class="mt-5 pb-4">
                ...
                <div class="form-row w-100 d-flex justify-content-center">
                    ...
                    <div class="input-group mb-3 col-md-5">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input img-input" name="imgFuncionario" id="imgFuncionario"
                                accept="image/*">
                ...
                <div class="form-row w-100">
                    <div class="form-group col-md-12 pb-2">
                        ...
                        <input type="text" class="form-control flat" name="txtNomeFuncionario" id="txtNomeFuncionario"
                ...
                <div class="form-row w-100">
                    ...
                    <div class="form-group col-md-6 pb-2">
                        ...
                        <input type="text" class="form-control txtCpf flat" id="txtCpfFuncionario" name="txtCpfFuncionario"
            ...
            <fieldset class="mt-5 pb-4">
                ...
                <div class="form-row w-100 mt-5 d-flex justify-content-center">
                    ...
                    <div class="form-group col-md-6 pb-2">
                        ...
                        <input type="email" class="form-control flat" name="txtEmailFuncionario" id="txtEmailFuncionario"
                    ...
                    <div class="form-group col-md-6 pb-2">
                        ...
                        <input type="password" class="form-control flat" name="psSenhaFuncionario" id="psSenhaFuncionario"
                            placeholder="Digite uma senha" maxlength="30" />
        ...
        <div class="modal fade" id="limpar-campos-conta" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
